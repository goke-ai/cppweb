...
#include <stdio.h>
#include <stdlib.h>
#include "../../../../../../../sdk/sqlite_amalgamation_3360000/sqlite3.h"
...
namespace db
{
   ...
   int connect(char *dbName = "test.db")
   {
      sqlite3 *db;
      char *zErrMsg = 0;
      int rc;
   ...
   int createSql(char *dbName = "test.db",
   ...
   int insertSql(char *dbName = "test.db",
                 /* Create SQL statement */
   ...
   int updateSql(char *dbName = "test.db",
   ...
   int deleteSql(char *dbName = "test.db",
                 /* Create merged SQL statement */
